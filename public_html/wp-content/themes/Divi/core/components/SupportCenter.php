...
class ET_Core_SupportCenter {
	...
	public function unlist_support_center() {
		...
		delete_option( 'et_hosting_card_dismissed' );
	}
	...
	protected function get_divi_hosting_features() {
		...
		return array(
			...
			'dismiss_tooltip' => esc_html__( 'Dismiss Divi Hosting Offers', 'et-core' ),
			'features'        => array(
				'server'   => array(
	...
	public function print_divi_hosting_card() {
		...
		// Add Divi Hosting Card in the Support Center if any system status item is in a
		// warning state (red dot indicator).
		if ( in_array( 'fail', array_values( $result ) ) ) {
